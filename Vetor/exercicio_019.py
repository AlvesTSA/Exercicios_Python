...
print("Projeçao de Gastos com Abono\n============================")

for i in range(0, 100):
    
    print(end="Salario: ")
    salari = float(input())
    salario.append(salari)
...
for i in range(0, count1):
    ...
    print(f"R$ {salario[i]} -  R$ {abono[i]}")

print(f"Foram processados {count1} colaboradores")
print(f"Total gasto com abonos: R$ {total}")
print(f"Valor mínimo pago a {count2} colaboradores")
