...
while True:
    ...
    while True:
        ...
        if op < 0 or op > 6:
            ...
            print("ERRO: Informe um valor de 1 a 6\n")
        else:
            break
...
print(f"Windows Server	    {votos[0]}	    {percentual[0]}")
print(f"Unix                {votos[1]}	    {percentual[1]}")
print(f"Linux	            {votos[2]}	    {percentual[2]}")
print(f"Netware	            {votos[3]}	    {percentual[3]}")
print(f"Mac OS	            {votos[4]}	    {percentual[4]}")
print(f"Outro	            {votos[5]}	    {percentual[5]}")
print(f"Total	            {total}")
